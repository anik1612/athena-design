    ...
    return (
        <div className="todo-wrapper">
            <div className="container my-5 py-5">
                <div className="text-center todo-title mb-5">
                    <h2>What we do</h2>
                    <p style={{color: '#8D8D8D'}} className='text-center'>Our main focus is to make the User Experience very <br /> simple and easy. Simplicity is our Strength.</p>
                </div>
                <div className="row text-center todo-detail">
                    <div className="col-md-3 todo">
                        <div className="m-4">
                            ...
                            <p style={{color: '#8D8D8D'}}>The point of using Lorem Ipsum is that it has a more-orless normal.</p>
                        </div>
                    </div>
                    <div className="col-md-3 todo">
                        <div className="m-4">
